<script lang="ts">
	...
	const top_stats = $derived([
		{
			...
			icon: 'M12 3l2.7 5.5 6.1.9-4.4 4.3 1 6.1L12 17l-5.4 2.8 1-6.1L3.2 9.4l6.1-.9z',
			color: '#d97706',
			bg: 'rgba(217, 119, 6, 0.08)', border: 'rgba(217, 119, 6, 0.25)'
		},
		{
			label: 'Equiv. Bs',
			value: `Bs. ${user.cash_equiv}`,
		...
		{
			label: 'Reciclado',
			value: `${user.recycled_kg}kg`,
			icon: 'M3 12a9 9 0 0 1 15.2-6.4M18.2 5.6V2.4h-3.2M21 12a9 9 0 0 1-15.2 6.4M5.8 18.4v3.2H9',
			color: '#0284c7',
			bg: 'rgba(2, 132, 199, 0.08)', border: 'rgba(2, 132, 199, 0.25)'
		},
		{
			label: 'Reportes',
	...
	const insignias: Insignia[] = [
		{
			...
			desc: 'Realizaste tu primera entrega de reciclaje',
			icon_path: 'M11 20A7 7 0 0 1 4 13c0-6 7-10 16-10a14 14 0 0 1-9 17M9 14l6-6',
			color: '#16a34a',
			bg: 'rgba(22, 163, 74, 0.08)', border: 'rgba(22, 163, 74, 0.25)',
			earned: true,
			date: 'Ene 2026'
		},
		{
			id: 'i2',
			title: '10 Entregas',
			desc: 'Completaste 10 entregas de materiales',
			icon_path:
		...
		},
		{
			...
			desc: 'Entregaste más de 10 kg de vidrio',
			icon_path:
				'M8 21h8M12 17v4M7 4h10v2a5 5 0 0 1-10 0zM5 6H3a2 2 0 0 0 0 4h2M19 6h2a2 2 0 0 1 0 4h-2',
			color: '#d97706',
			bg: 'rgba(217, 119, 6, 0.08)', border: 'rgba(217, 119, 6, 0.25)',
			earned: true,
			date: 'Abr 2026'
		...
		{
			id: 'i4',
			title: 'Eco-Héroe del Mes',
			desc: 'Fuiste el mayor contribuyente de tu zona',
			icon_path: 'M12 3l2.7 5.5 6.1.9-4.4 4.3 1 6.1L12 17l-5.4 2.8 1-6.1L3.2 9.4l6.1-.9z',
			color: '#7c3aed',
			bg: 'rgba(124, 58, 237, 0.08)', border: 'rgba(124, 58, 237, 0.25)',
			earned: false
		},
		{
			...
			desc: 'Tu reporte fue atendido por la GAMC',
			icon_path:
				'M9 4h6a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2zM9 8h6M9 12h6M9 16h4',
			color: '#dc2626',
			bg: 'rgba(220, 38, 38, 0.08)', border: 'rgba(220, 38, 38, 0.25)',
			earned: true,
			date: 'May 2026'
	...
	type Actividad = {
		id: number;
		tipo: 'entrega' | 'reporte' | 'canje' | 'nivel';
		desc: string;
		puntos: number;
		fecha: string;
	};
	const actividad_reciente: Actividad[] = [
		{
			id: 1,
			tipo: 'entrega',
			desc: 'Entrega de 3.2 kg de plástico PET',
			puntos: 128,
			fecha: '15 May'
		},
		{
			id: 2,
			tipo: 'reporte',
			desc: 'Reporte en Av. América procesado',
			puntos: 50,
			fecha: '13 May'
		},
		{
			id: 3,
			tipo: 'entrega',
			desc: 'Entrega de 2 kg de papel y cartón',
			puntos: 70,
			fecha: '11 May'
		},
		{
			id: 4,
			tipo: 'nivel',
			desc: '¡Subiste al Nivel 4 — Eco-Ciudadano Pro!',
			puntos: 0,
			fecha: '08 May'
		},
		{
			id: 5,
			tipo: 'canje',
			desc: 'Canjeaste: Café Orgánico Boliviano',
			puntos: -150,
			fecha: '05 May'
		}
	];
	...
	const store_items: StoreItem[] = [
		{
			id: 's1',
			name: 'Café Orgánico Boliviano',
			partner: 'Café La Casona',
			category: 'cafeteria',
			points: 150,
			discount_pct: 20,
			type: 'descuento',
		...
		{
			id: 's2',
			name: 'Bolsa Eco-Reutilizable',
			partner: 'EcoBolivia',
			category: 'bolivia',
			points: 80,
			discount_pct: 100,
			type: 'producto',
			description: 'Bolsa de tela certificada hecha en Bolivia'
		},
		{
			id: 's3',
			name: 'Menú Eco-Lunch',
			partner: 'Restaurante Verde',
			category: 'restaurante',
			points: 200,
			discount_pct: 15,
			type: 'descuento',
			description: 'Menú del día con ingredientes ecológicos'
		},
		{
			id: 's4',
			name: 'Kit de Reciclaje',
			partner: 'EcoTienda Naturaleza',
			category: 'ecostore',
			points: 320,
			discount_pct: 100,
			type: 'producto',
			description: 'Contenedores clasificadores x 4 colores'
		},
		{
			id: 's5',
			...
			discount_pct: 25,
			type: 'descuento',
			description: 'Para 2 personas, incluye postres orgánicos'
		},
		{
			id: 's6',
			name: 'Planta de Interior',
			partner: 'Vivero EcoVerde',
			category: 'ecostore',
			points: 250,
			discount_pct: 100,
			type: 'producto',
			description: 'Planta nativa de Bolivia, certificada'
		},
		{
			id: 's7',
			name: 'Bicicleta Compartida',
			partner: 'BiciVerde Cbba',
			category: 'transporte',
			points: 300,
			discount_pct: 50,
			type: 'descuento',
			description: '1 mes de acceso a bicicletas compartidas'
		},
		{
			id: 's8',
			...
			discount_pct: 100,
			type: 'producto',
			description: 'Curso presencial de compostaje doméstico'
		}
	];
	...
	const municipal_benefits: MunicipalBenefit[] = [
		{
			id: 'b1',
			title: 'Descuento Predial 5%',
			desc: 'Descuento simbólico sobre impuesto a la propiedad inmueble para el siguiente semestre.',
		...
		{
			id: 'b2',
			title: 'Certificado Eco-Responsable',
			desc: 'Reconocimiento público emitido por la GAMC que acredita tu compromiso ambiental.',
			points_required: 800,
		...
		{
			id: 'b3',
			title: 'Prioridad en Trámites',
			desc: 'Acceso preferente en ventanillas municipales de servicios ciudadanos de la GAMC.',
		...
		{
			id: 'b4',
			title: 'Fondo de Mejora Barrial',
			desc: 'Tu zona acumula puntos comunitarios para financiar parques e iluminación pública.',
		...
		{
			id: 'b5',
			title: 'Descuento en Tasas 10%',
			desc: 'Descuento aplicable sobre tasas de servicios de agua y recolección de residuos.',
	...
	const benefit_status_labels: Record<BenefitStatus, string> = {
		...
		por_alcanzar: 'Por alcanzar',
		obtenido: 'Obtenido'
	};

	// ─── Tab state ────────────────────────────────────────────────────────────
	let active_tab: 'inicio' | 'individual' | 'condominio' | 'tienda' | 'municipal' =
		$state('inicio');
	...
	const impact_stats = [
		...
		},
		{
			...
			value: '24',
			icon: 'M12 21s-8-7.5-8-12a8 8 0 0 1 16 0c0 4.5-8 12-8 12z',
			color: '#7c3aed'
		},
		{
			label: 'Zonas beneficiadas',
			value: '18',
			icon: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z',
			color: '#059669'
		}
		...
		<div class="top_stat_card" style="background:{s.bg};border-color:{s.border}">
			<div class="top_stat_icon" style="color:{s.color}">
				<svg
					...
					aria-hidden="true"><path d={s.icon} /></svg
				>
			</div>
...
<div class="tab_switcher">
	{#each [['inicio', 'Inicio', 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zM9 22V12h6v10'], ['individual', 'Yo', 'M4 11.5L12 5l8 6.5M6 10.8V20h12v-9.2M10 20v-4h4v4'], ['condominio', 'Edificio', 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zM9 22V12h6v10'], ['tienda', 'Tienda', 'M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4zM3 6h18M16 10a4 4 0 0 1-8 0'], ['municipal', 'GAMC', 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z']] as [id, label, icon]}
		<button
			class="tab_btn"
			class:tab_active={active_tab === id}
			onclick={() => (active_tab = id as typeof active_tab)}
		>
			<svg
				viewBox="0 0 24 24"
				fill="none"
				...
				aria-hidden="true"><path d={icon} /></svg
			>
			{label}
		</button>
	{/each}
...
{#if active_tab === 'inicio'}
	<div class="inicio_hero">
		...
		<h2 class="inicio_hero_title">
			Bienvenida,<br /><span class="inicio_name">{user.name.split(' ')[0]}</span>
			<span class="inicio_wave_icon" aria-hidden="true"
				><svg
					viewBox="0 0 24 24"
					fill="none"
					stroke="currentColor"
					...
					><path d="M3 12c2.5-4 5.5-4 8 0s5.5 4 8 0M5 9c2-3 4-3 6 0M13 15c2 3 4 3 6 0" /></svg
				></span
			>
		</h2>
		<p class="inicio_hero_sub">
			Sos parte del movimiento ambiental más grande de Cochabamba. Cada entrega suma, cada reporte
			importa.
		</p>
	</div>
	...
	<div class="panel inicio_section">
		<div class="inicio_section_head">
			<div
				class="inicio_section_icon"
				style="background: rgba(22, 163, 74, 0.08);border-color: rgba(22, 163, 74, 0.25);color:#16a34a"
			>
				<svg
					viewBox="0 0 24 24"
					fill="none"
		...
		<p class="inicio_section_text">
			Ecochitas es una iniciativa tecnológica nacida en Cochabamba con la misión de modernizar la
			gestión de residuos sólidos. Combinamos sensores IoT, GPS y software avanzado para brindar
			herramientas a operadores municipales y motivar a los ciudadanos a reciclar.
		</p>
	</div>
	...
	<div class="panel inicio_section">
		<div class="inicio_section_head">
			<div
				class="inicio_section_icon"
				style="background: rgba(2, 132, 199, 0.08);border-color: rgba(2, 132, 199, 0.25);color:#0284c7"
			>
				<svg
					viewBox="0 0 24 24"
					fill="none"
		...
		<p class="inicio_section_text">
			Digitalizamos el ciclo completo de recolección: desde el monitoreo en tiempo real de camiones
			y sensores de llenado, hasta la validación de materiales reciclables entregados por vecinos,
			otorgándoles puntos canjeables por beneficios locales.
		</p>
	</div>
	...
	<div class="inicio_benefits_card">
		...
		<div class="inicio_benefits_list">
			{#each [{ icon: 'M12 3l2.7 5.5 6.1.9-4.4 4.3 1 6.1L12 17l-5.4 2.8 1-6.1L3.2 9.4l6.1-.9z', text: 'Ganás EcoPoints por cada entrega de reciclaje verificada' }, { icon: 'M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4zM3 6h18M16 10a4 4 0 0 1-8 0', text: 'Canjeás puntos por descuentos en tiendas y restaurantes locales' }, { icon: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z', text: 'Accedés a beneficios municipales de la GAMC por participación activa' }, { icon: 'M3 12a9 9 0 0 1 15.2-6.4M18.2 5.6V2.4h-3.2M21 12a9 9 0 0 1-15.2 6.4M5.8 18.4v3.2H9', text: 'Contribuís directamente a reducir la contaminación en tu ciudad' }] as b}
				<div class="inicio_benefit_item">
					<div class="inicio_benefit_dot">
						<svg
							...
							stroke-width="1.9"
							style="width:13px;height:13px"
							aria-hidden="true"><path d={b.icon} /></svg
						>
					</div>
					<span>{b.text}</span>
				</div>
	...
	<!-- Educación ambiental -->
	<div class="panel">
		<h3 class="section_title section_title_with_icon" style="margin-bottom:0.85rem">
			<svg
				viewBox="0 0 24 24"
				fill="none"
				stroke="currentColor"
				...
				aria-hidden="true"
				><path
					d="M9 18h6M10 22h4M12 2a7 7 0 0 0-4 12.7c.8.56 1.3 1.5 1.3 2.5V18h5.4v-.8c0-1 .5-1.94 1.3-2.5A7 7 0 0 0 12 2z"
				/></svg
			>Educación Ambiental
		</h3>
		<div class="edu_list">
			{#each [{ tip: 'Enjuagá los envases plásticos antes de llevarlos al punto de acopio para evitar el rechazo.', color: '#0284c7', bg: '#eff6ff' }, { tip: 'El papel húmedo no se recicla. Guardá tu papel y cartón en lugar seco y entregalos limpio.', color: '#92400e', bg: '#fef3c7' }, { tip: 'Las pilas y baterías son residuos especiales — solo en puntos de acopio autorizados por la GAMC.', color: '#dc2626', bg: '#fef2f2' }] as e, i}
		...
		<div class="mapa_preview_left">
			<div class="mapa_preview_icon">
				<svg
					...
					aria-hidden="true"><polygon points="3 11 22 2 13 21 11 13 3 11" /></svg
				>
			</div>
			<div>
...
{:else if active_tab === 'individual'}
	...
	<div class="wallet_card">
		<div class="wallet_header">
			<svg
				...
				stroke-linejoin="round"
				stroke-width="1.9"
				style="width:17px;height:17px;opacity:0.75"
				aria-hidden="true"
		...
		<div class="cash_disclaimer">
			<svg
				...
				stroke-linejoin="round"
				stroke-width="1.9"
				style="width:11px;height:11px;flex-shrink:0;margin-top:1px;opacity:0.7"
				aria-hidden="true"
			...
			>
			<span
				>≈ <strong>Bs. {user.cash_equiv}</strong> equivalencia referencial. Esto NO es dinero real — es
				una estimación si el material hubiese sido vendido directamente por vos.</span
			>
		</div>
	...
	<div class="panel nivel_panel">
		<div class="nivel_head_row">
			...
			<div>
				...
				<p class="nivel_sub">
					Nivel {current_nivel.num} — {current_nivel.nombre} · +{current_nivel.bonus}% bonus
				</p>
			</div>
		</div>
		<div class="nivel_progress_row">
			...
			{#if next_nivel}
				<span class="nivel_next_text"
					>→ {next_nivel.min.toLocaleString()} pts para Nv. {next_nivel.num}</span
				>
			{:else}
				<span class="nivel_next_text" style="color:var(--ecochitas-leaf)"
					>¡Nivel máximo alcanzado!</span
				>
			{/if}
		</div>
		...
		{#if next_nivel}
			<p class="nivel_hint">
				Faltan <strong>{(next_nivel.min - user.points).toLocaleString()} pts</strong> para {next_nivel.nombre}
			</p>
		{/if}
		...
		<div class="nivel_table_scroll">
			<div class="nivel_table">
				{#each niveles as n (n.num)}
					<div
						class="nivel_row"
						class:nivel_row_active={n.num === current_nivel.num}
						class:nivel_row_locked={user.points < n.min}
					>
		...
		<div class="nivel_inactivity_warn">
			<svg
				...
				stroke-linejoin="round"
				stroke-width="1.9"
				style="width:12px;height:12px;flex-shrink:0;margin-top:1px"
				aria-hidden="true"
				><path
			...
			>
			<span
				>La inactividad prolongada (más de 30 días sin entregas) puede reducir tu nivel. ¡Mantenete
				activo!</span
			>
		</div>
	</div>
	...
	<div class="panel">
		<div class="section_row">
			<svg
				...
				aria-hidden="true"
				><path d="M12 3l2.7 5.5 6.1.9-4.4 4.3 1 6.1L12 17l-5.4 2.8 1-6.1L3.2 9.4l6.1-.9z" /></svg
			>
			<h2 class="section_title">Progreso Este Mes</h2>
		</div>
		<div class="progress_row">
			<span class="progress_label">Meta Mensual</span>
			<span class="progress_val" style="color:var(--ecochitas-sky)"
				>{user.points.toLocaleString()} / {user.monthly_goal.toLocaleString()}</span
			>
		</div>
		<div class="progress_track"><div class="progress_fill" style="width:{monthly_pct}%"></div></div>
		<div class="stats_duo">
			<div class="stat_pill stat_pill_green">
				<strong class="stat_big">{user.deliveries}</strong><span class="stat_small">Entregas</span>
			</div>
			<div class="stat_pill stat_pill_blue">
				<strong class="stat_big stat_blue">{user.recycled_kg}kg</strong><span class="stat_small"
					>Reciclado</span
				>
			</div>
		</div>
		...
		<div class="validator_section">
			...
			<p class="validator_sub">
				Subí fotos de tus entregas como evidencia. Un operador las revisará y acreditará los puntos.
			</p>
	...
	<div class="impact_card">
		<div class="impact_header">
			<span class="impact_emoji" aria-hidden="true"
				><svg
					viewBox="0 0 24 24"
					fill="none"
					stroke="currentColor"
					...
					><path d="M11 20A7 7 0 0 1 4 13c0-6 7-10 16-10a14 14 0 0 1-9 17M9 14l6-6" /></svg
				></span
			>
	...
	<div class="panel">
		...
		<div class="insignias_grid">
			{#each insignias as ins (ins.id)}
				<div
					class="insignia_card"
					class:insignia_locked={!ins.earned}
					style="background:{ins.earned
						? ins.bg
						: 'var(--ecochitas-surface)'};border-color:{ins.earned
						? ins.border
						: 'var(--ecochitas-border)'}"
				>
					<span class="insignia_emoji" class:insignia_emoji_locked={!ins.earned}
						><svg
							viewBox="0 0 24 24"
							fill="none"
							stroke="currentColor"
							...
							stroke-width="1.9"
							style="width:18px;height:18px"
							aria-hidden="true"><path d={ins.icon_path} /></svg
						></span
					>
					<strong
						class="insignia_title"
						style="color:{ins.earned ? ins.color : 'var(--ecochitas-muted)'}">{ins.title}</strong
					>
	...
	<div class="panel">
		...
		<h2 class="section_title" style="margin-top:1.1rem;margin-bottom:0.75rem">
			Actividad Reciente
		</h2>
		<div class="activity_list">
			{#each actividad_reciente as act (act.id)}
				<div class="activity_item">
					<div
						class="activity_icon"
						style="background:color-mix(in srgb,{actividad_colors[
							act.tipo
						]} 12%,transparent);border-color:color-mix(in srgb,{actividad_colors[
							act.tipo
						]} 25%,transparent);color:{actividad_colors[act.tipo]}"
					>
						<svg
							viewBox="0 0 24 24"
							fill="none"
							...
							stroke-width="1.75"
							style="width:14px;height:14px"
							aria-hidden="true"><path d={actividad_icons[act.tipo]} /></svg
						>
					</div>
					...
					<span
						class="activity_pts"
						class:activity_pts_neg={act.puntos < 0}
						class:activity_pts_zero={act.puntos === 0}
					>
...
{:else if active_tab === 'condominio'}
	...
	<div class="panel">
		<div class="progress_row">
			...
			<span class="progress_val" style="color:var(--ecochitas-sky)"
				>{building.community_points.toLocaleString()} / {building.community_goal.toLocaleString()}</span
			>
		</div>
		<div class="progress_track">
			<div class="progress_fill" style="width:{community_pct}%"></div>
		</div>
		<p class="progress_hint">
			Faltan {(building.community_goal - building.community_points).toLocaleString()} puntos para alcanzar
			la meta
		</p>
	</div>
		...
		<div class="rank_list">
			{#each top_contributors as contrib, i (contrib.unit)}
				<div class="rank_row" class:rank_row_gold={i === 0}>
					<div
						class="rank_badge"
						class:rank_badge_gold={i === 0}
						class:rank_badge_silver={i === 1}
						class:rank_badge_bronze={i === 2}
					>
						{i + 1}
					</div>
					<span class="rank_unit">{contrib.unit}</span>
					<div class="rank_right">
						<strong class="rank_pts" class:rank_pts_gold={i === 0}
							>{contrib.points.toLocaleString()}</strong
						>
	...
	<div class="benefits_card">
		<div class="benefits_header">
			<span class="benefits_emoji" aria-hidden="true"
				><svg
					viewBox="0 0 24 24"
					fill="none"
					stroke="currentColor"
					...
					style="width:18px;height:18px"
					><path
						d="M8 21h8M12 17v4M7 4h10v2a5 5 0 0 1-10 0zM5 6H3a2 2 0 0 0 0 4h2M19 6h2a2 2 0 0 1 0 4h-2"
					/></svg
				></span
			>
			...
			{#each ['Descuentos grupales en impuestos municipales', 'Reconocimiento como Edificio Eco-Responsable GAMC', 'Acceso prioritario a programas de mejora urbana'] as b}
				<li class="benefit_item">
					<svg
						...
						stroke-linejoin="round"
						stroke-width="2.2"
						style="width:11px;height:11px;flex-shrink:0;margin-top:2px;opacity:0.8"
						aria-hidden="true"><polyline points="20 6 9 17 4 12" /></svg
					>
					{b}
				</li>
...
{:else if active_tab === 'tienda'}
	<div class="store_hero">
		<div class="store_hero_icon" aria-hidden="true">
			<svg
				viewBox="0 0 24 24"
				fill="none"
				stroke="currentColor"
		...
		<div>
			...
			<p class="store_hero_sub">
				Canjeá tus EcoPoints por descuentos y productos en negocios locales.
			</p>
		</div>
	...
	<div class="filter_scroll">
		<div class="filter_pills">
			{#each [['todos', 'Todos'], ['cafeteria', 'Cafeterías'], ['restaurante', 'Restaurantes'], ['ecostore', 'Eco-Tiendas'], ['bolivia', 'Bolivia'], ['transporte', 'Transporte'], ['educacion', 'Educación']] as [id, label]}
				<button
					class="filter_pill"
					class:filter_pill_active={store_filter === id}
					onclick={() => (store_filter = id as typeof store_filter)}
				>
					{label}
				</button>
			{/each}
				...
				<div class="store_logo_area">
					<div class="store_logo_placeholder">
						<svg
							...
							stroke-linejoin="round"
							stroke-width="1.5"
							style="width:20px;height:20px;opacity:0.35"
							aria-hidden="true"
							><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4zM3 6h18" /></svg
						>
					</div>
					<div class="store_card_badges">
						<span
							class="store_cat_tag"
							style="background:{category_labels[item.category].bg};color:{category_labels[
								item.category
							].color}"
						>
...
{:else if active_tab === 'municipal'}
	<div class="muni_hero">
		<div class="muni_hero_icon" aria-hidden="true">
			<svg
				viewBox="0 0 24 24"
				fill="none"
				stroke="currentColor"
				...
				stroke-width="1.9"
				style="width:22px;height:22px"
				><path d="M3 10h18M5 10V7l7-4 7 4v3M6 10v8M10 10v8M14 10v8M18 10v8M3 18h18" /></svg
			>
		</div>
		<div>
			<h2 class="muni_hero_title">Beneficios Municipales</h2>
			<p class="muni_hero_sub">
				La GAMC recompensa a ciudadanos activos con descuentos y reconocimientos oficiales.
			</p>
		</div>
	</div>
	...
	<div class="muni_mvp_notice">
		...
		>
		<span
			><strong>Propuesta MVP:</strong> Los beneficios municipales mostrados son propuestas/recompensas
			modelo para demostración del sistema. Su implementación real depende de la GAMC.</span
		>
	</div>
	...
	<div class="muni_list">
		{#each municipal_benefits as b (b.id)}
			<div class="muni_card" class:muni_card_available={user.points >= b.points_required}>
				<div
					class="muni_card_icon"
					style="background:color-mix(in srgb,{b.color} 12%,transparent);border-color:color-mix(in srgb,{b.color} 25%,transparent);color:{b.color}"
				>
					<svg
						viewBox="0 0 24 24"
						fill="none"
				...
				<div class="muni_card_body">
					...
					<div class="muni_card_foot">
						...
						{:else}
							<span class="muni_pts_falt"
								>Faltan {(b.points_required - user.points).toLocaleString()} EP</span
							>
						{/if}
					</div>
				</div>
...
<style>
	...
	.avatar_level_ring {
		...
		inset: -3px;
		border-radius: 50%;
		border: 2px solid var(--ecochitas-leaf);
		opacity: 0.6;
		pointer-events: none;
	}
	.user_name {
	...
	:root[data-theme='dark'] .streak_chip {
	...
	.tab_active {
		...
		color: white;
		box-shadow: 0 3px 10px color-mix(in srgb, var(--ecochitas-leaf) 40%, transparent);
	}

	/* ── Inicio tab ── */
	.inicio_hero {
		background: linear-gradient(145deg, oklch(0.22 0.09 175), oklch(0.3 0.11 163));
	...
	.inicio_benefits_card {
		background: linear-gradient(145deg, oklch(0.97 0.02 163), oklch(0.94 0.04 170));
		border: 1.5px solid #bbf7d0;
		border-radius: 1.5rem;
		padding: 1.25rem 1.35rem;
	}
	:root[data-theme='dark'] .inicio_benefits_card {
		background: rgba(34, 197, 94, 0.07);
		border-color: rgba(34, 197, 94, 0.2);
	}
	.inicio_benefits_title {
		font-size: 0.95rem;
		font-weight: 800;
		color: #166534;
	...
	:root[data-theme='dark'] .inicio_benefits_title {
		color: #4ade80;
	}
	.inicio_benefits_list {
		display: flex;
		flex-direction: column;
		gap: 0.65rem;
	}
	...
	:root[data-theme='dark'] .inicio_benefit_item {
		color: #4ade80;
	}
	.inicio_benefit_dot {
		flex-shrink: 0;
	...
	/* ── EcoWallet ── */
	.wallet_card {
		background: linear-gradient(145deg, oklch(0.3 0.11 163), oklch(0.22 0.09 175));
		border-radius: 1.5rem;
	...
	.nivel_badge_icon {
		...
		border: 1.5px solid color-mix(in srgb, #d97706 25%, transparent);
		display: flex;
		align-items: center;
		justify-content: center;
		color: #d97706;
	...
	:root[data-theme='dark'] .nivel_row_active {
	...
	.nivel_row_active .nivel_row_num {
		color: #d97706;
	}
	.nivel_row_name {
		font-size: 0.58rem;
	...
	:root[data-theme='dark'] .nivel_inactivity_warn {
	...
	.stat_blue {
		color: var(--ecochitas-sky) !important;
	}
	.stat_small {
		font-size: 0.72rem;
		color: var(--ecochitas-muted);
	...
	:root[data-theme='dark'] .val_icon_validado {
		background: rgba(34, 197, 94, 0.15);
	}
	:root[data-theme='dark'] .val_icon_pendiente {
		background: rgba(245, 158, 11, 0.15);
	}
	:root[data-theme='dark'] .val_icon_rechazado {
		background: rgba(239, 68, 68, 0.15);
	}
	.val_info {
		flex: 1;
	...
	:root[data-theme='dark'] .val_status_validado {
		background: rgba(34, 197, 94, 0.15);
		color: #4ade80;
	}
	.val_status_pendiente {
		background: rgba(234, 179, 8, 0.08);
		color: #854d0e;
	}
	:root[data-theme='dark'] .val_status_pendiente {
		background: rgba(245, 158, 11, 0.15);
		color: #fbbf24;
	}
	.val_status_rechazado {
		background: rgba(220, 38, 38, 0.08);
		color: #b91c1c;
	}
	:root[data-theme='dark'] .val_status_rechazado {
		background: rgba(239, 68, 68, 0.15);
		color: #fca5a5;
	}
	.val_pts {
	...
	:root[data-theme='dark'] .streak_card {
		background: rgba(239, 68, 68, 0.1);
	}
	.streak_card_muted {
		background: var(--ecochitas-surface) !important;
		border-color: var(--ecochitas-border) !important;
	}
	.streak_val {
		font-size: 1rem;
		font-weight: 900;
	...
	:root[data-theme='dark'] .streak_val {
		color: #f87171;
	}
	.streak_val_muted {
		color: var(--ecochitas-muted) !important;
	}
	.streak_lbl {
		font-size: 0.65rem;
		color: var(--ecochitas-muted);
	...
	:root[data-theme='dark'] .activity_pts_neg {
	...
	:root[data-theme='dark'] .reward_title {
		color: #fcd34d;
	}
	.reward_desc {
		font-size: 0.78rem;
	...
	:root[data-theme='dark'] .reward_desc {
		color: #fde68a;
	}
	.reward_rank {
		display: inline-flex;
	...
	:root[data-theme='dark'] .reward_rank {
		color: #fbbf24;
	}
	.rank_list {
		display: flex;
	...
	.store_hero {
		...
		border-radius: 1.5rem;
		background: linear-gradient(145deg, oklch(0.95 0.03 290), oklch(0.92 0.04 280));
		border: 1.5px solid oklch(0.87 0.06 285);
		flex-wrap: wrap;
	}
	:root[data-theme='dark'] .store_hero {
	...
	:root[data-theme='dark'] .store_hero_title {
		color: #c4b5fd;
	}
	.store_hero_sub {
		font-size: 0.78rem;
	...
	:root[data-theme='dark'] .store_hero_sub {
		color: #a78bfa;
	}
	.store_pts_chip {
		margin-left: auto;
	...
	:root[data-theme='dark'] .muni_mvp_notice {
		background: rgba(245, 158, 11, 0.08);
		border-color: rgba(245, 158, 11, 0.25);
		color: #fcd34d;
	}
	.muni_mvp_notice strong {
		font-weight: 800;
	}
	.muni_progress_card {
		padding: 1rem 1.1rem;
	...
	:root[data-theme='dark'] .muni_card_available {
	...
	.muni_status_disponible {
		background: rgba(34, 197, 94, 0.08);
		color: #166534;
	}
	:root[data-theme='dark'] .muni_status_disponible {
		background: rgba(34, 197, 94, 0.15);
		color: #4ade80;
	}
	.muni_status_por_alcanzar {
		background: rgba(234, 179, 8, 0.08);
		color: #854d0e;
	}
	:root[data-theme='dark'] .muni_status_por_alcanzar {
		background: rgba(234, 179, 8, 0.15);
		color: #fbbf24;
	}
	.muni_status_obtenido {
		background: rgba(139, 92, 246, 0.08);
		color: #4c1d95;
	}
	.muni_claim_btn {
	...
	@media screen and (min-width: 640px) {
		.stats_bar { grid-template-columns: repeat(5, 1fr) !important; }
		.insignias_grid { grid-template-columns: repeat(6, 1fr) !important; }
		.store_grid { grid-template-columns: repeat(3, 1fr) !important; }
		.top_stats_row { flex-wrap: nowrap !important; }
	}
	@media screen and (min-width: 1024px) {
		.stats_bar { grid-template-columns: repeat(5, 1fr) !important; }
		.insignias_grid { grid-template-columns: repeat(8, 1fr) !important; }
		.store_grid { grid-template-columns: repeat(4, 1fr) !important; }
	}
